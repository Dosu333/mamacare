...
def get_patient_medications(patient_id: str, created_at: str = None):
    try:
...
schema_get_patient_medications = types.FunctionDeclaration(
    name="get_patient_medications",
    description="Get drugs/medications prescribed to a patient",
